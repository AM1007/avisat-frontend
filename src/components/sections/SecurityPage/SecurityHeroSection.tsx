      ...
      <Container>
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            Це системи, які передбачають ризики, реагують миттєво та інтегрується у ваш побут<br/> У сучасному світі безпека – це не просто сигналізація чи кілька камер 
          </p>
